  ...
  !(function (t) {
      ...
      var i = function () {
        ...
        r = function (t) {
          var e = t.getBoundingClientRect(),
            ...
            i = window;
          return { top: e.top + i.pageYOffset - n.clientTop, left: e.left + i.pageXOffset - n.clientLeft };
        },
        a = function (t, e, n) {
          var i = function t(i) {
      ...
      var r = null,
        ...
        l = function (t) {
          return document.body.classList.contains("zoom-overlay-open")
            ...
            : void (t.target.width >= n.i(o.a)() - a || (d(!0), (r = new i.a(t.target, a)), r.zoom(), m()));
        },
        d = function (t) {
          null != r && (t ? r.dispose() : r.close(), f(), (r = null));
        },
        m = function () {
          document.addEventListener("scroll", h), document.addEventListener("keyup", v), document.addEventListener("touchstart", p), document.addEventListener("click", y, !0);
        },
        f = function () {
          document.removeEventListener("scroll", h), document.removeEventListener("keyup", v), document.removeEventListener("touchstart", p), document.removeEventListener("click", y, !0);
        },
        h = function () {
        ...
        g = function t(e) {
          var n = e.touches[0];
          null != n && Math.abs(n.pageY - u) > 10 && (d(), e.target.removeEventListener("touchmove", t));
        },
        y = function () {
          d();
        },
    ...
    function (n, i, o) {
      var r = o(0),
        ...
        s = (function () {
          function n(e, i) {
            t(this, n), (this.img = e), (this.preservedTransform = e.style.transform), (this.wrap = null), (this.overlay = null), (this.offset = i);
          }
          return (
            e(n, [
              {
    ...
    function (t, e, n) {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        for (var t = document.querySelectorAll("img[data-action='zoom']"), e = 0; e < t.length; e++) i.a.setup(t[e]);
      });
    },
  ]);
})();
